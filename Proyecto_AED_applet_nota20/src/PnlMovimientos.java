...
public class PnlMovimientos extends JPanel implements ActionListener,
    ...
    public PnlMovimientos(Principal p) {
        ...
        datos.addColumn("C�digo Almac�n");
        datos.addColumn("Proveedor");
        datos.addColumn("C�digo Producto");
        ...
        JLabel lblNumero = new JLabel("N�mero",SwingConstants.LEFT);
        ...
        String tipodoc[] = {"Seleccione","Boleta","Factura","Gu�a de remisi�n",
                           "Orden de compra"};
        ...
        JLabel lblCategoria = new JLabel("Categor�a de producto",SwingConstants.LEFT);
        ...
        JLabel lblTransaccion = new JLabel("Transacci�n",SwingConstants.LEFT);
    ...
    private void distribuir() { //envia 2 al generarKardex()
       ...
       //Cantidad disponible del producto en el almac�n
       ...
       if(cantdisp >= cantreq) {
           ...
           if(cantreq <= capacdisp) {
               ...
               //Actualiza la cantidad de prendas en el almac�n
               ...
               JOptionPane.showMessageDialog(this,"�Distribuci�n realizada!");
           ...
           //Si es que no se puede almacenar la cantidad requerida en la tienda
               ...
               switch(capacdisp) {
                   case 0: JOptionPane.showMessageDialog(this,"�Ya no se pueden "+
                                        "ingresar m�s prendas en esta tienda!");
                           break;
